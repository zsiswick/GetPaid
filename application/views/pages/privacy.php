	...
	<div class="row">
		<div class="columns small-10 small-centered text-center">
			...
			<div class="invoice-form light-bg text-left">
				...
				<p>We implement a variety of security measures enters, submits, or accesses their information
				...
				<h4>We use cookies to:</h4>
				      <p><ul><li>Help remember and process the items in the shopping cart.</li>
				      <li>Understand and save user's preferences for future visits.</li></ul></p>
				...
				<p>We currently don't have the technology</p>
				...
				We will notify the users via email within 7 business days</p>
				...
				<p>rubyinvoice.com<br/>
				15 Apple D Or Rd<br/>
				Framingham, MA<br/>
				01701<br/>
				USA
				hello@rubyinvoice.com
				</p>
				
				<p>Last Edited on 2014-09-05</p>
			</div>
