...
<section class="content">
	<div class="row">
		<div class="columns large-5">
			<h3>Create invoices in a flash</h3>
			<p class="big-p light">Invoicing shouldn't be painful. Add a personalized logo, customize your settings, and you'll never have to waste time entering things manually again.</p>
		</div>
		<div class="columns large-7">
			<img class="screen shadow" src="<?php echo base_url()."/assets/images/clients-view.jpg"; ?>" alt="" />
		</div>
		<div class="small-12 columns pad-top"><hr class="light-bg"></div>
	</div>
</section>
...
<section class="content">
	<div class="row">
		<div class="columns large-push-7 large-5">
			<h3>See who owes you what</h3>
			<p class="big-p light">Ruby Invoice has a handy dashboard that shows you exactly how much money has yet to be invoiced, how much is due, and how much  you've earned from your paid invoices.</p>
		</div>
...
<section class="content">
	<div class="row">
		<div class="columns large-push-7 large-5">
			...
			<p class="big-p light">You can send thank you emails to your clients when they settle an invoice. Setup automatic reminders and you'll be sure your client is properly notified when an invoice is overdue, while you focus on your work.</p>
		</div>
		<div class="columns large-pull-5 large-7">
...
<section class="content">
	<div class="row">
		...
		<div class="columns small-12 text-center">
			<h2>Ready to start getting paid faster?</h2>
