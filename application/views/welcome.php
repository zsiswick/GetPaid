<section class="content">
	<div class="row">
		...
		<div class="large-pull-6 large-6 small-text-center large-text-left columns">
			<h1>Ruby Invoice</h1>
			<p class="big-p light">The free mobile-friendly billing service that helps you create professional quotes and invoices, track and collect payments, and set overdue reminders with neither muss, nor fuss.</p>
...
<section class="content">
	<div class="row">
		...
		<div class="columns large-6 small-text-center large-text-left">
			<h2>Who it's For</h2>
			<p class="big-p light">Ruby Invoice was created for freelancers, designers, startups and the like. Our focus is to provide an invoicing suite that's easy on the eyes and usable on your mobile phone, (not just in front of your desktop).</p> <p class="big-p light">We know how your time is at a premium, so we've put a lot of our time into features that will speed up invoice creation, and hopefully get you paid faster too.</p>
...
<section class="content">
	<div class="row">
		...
		<div class="columns large-6 large-pull-6 small-text-center large-text-left">
			...
			<p class="big-p light">Ruby Invoice makes billing a snap, with a simple interface and time-saving tools, (like international currencies, auto-reminders, project quotes, and a dashboard that tracks all of your outstanding and paid invoices to name a few).</p> <p class="big-p light">Getting paid gets easier too. With <a href="https://stripe.com">Stripe</a>, you can accept credit cards and collect payment directly from your invoices.</p>
